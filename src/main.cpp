...
int main(int argc, char **argv) {
    ...
    NeuronGroup serotonin_red_group = snn_net.create_group(serotonin_group_opts, drawer_top);
    t2 = high_resolution_clock::now();
    func_exec_time = (t2 - t1);
    ...
    NeuronGroup dopamine_green_group = snn_net.create_group(dopamine_group_opts, drawer_top);
    t2 = high_resolution_clock::now();
    func_exec_time = (t2 - t1);
    ...
    t1 = high_resolution_clock::now();
    snn_net.connect_groups(&vision_red_group, &serotonin_red_group, &drawer_top);
    t2 = high_resolution_clock::now();
    func_exec_time = (t2 - t1);
    drawer.connect_nodes(vision_red_group.name, serotonin_red_group.name);
    ...
    t1 = high_resolution_clock::now();
    snn_net.connect_groups(&vision_green_group, &dopamine_green_group, &drawer_top);
    t2 = high_resolution_clock::now();
    func_exec_time = (t2 - t1);
    ...
    // Fake Coin -> Serotonin
    t1 = high_resolution_clock::now();
    //snn_net.connect_groups(&fake_coin_group, &dopamine_group, &drawer_top);
    t2 = high_resolution_clock::now();
    func_exec_time = (t2 - t1);
    ...
    t1 = high_resolution_clock::now();
    snn_net.connect_groups(&serotonin_red_group, &bad_mt_serotonin_group, &drawer_top);
    t2 = high_resolution_clock::now();
    func_exec_time = (t2 - t1);
    ...
    t1 = high_resolution_clock::now();
    snn_net.connect_groups(&dopamine_green_group, &good_mt_dopamine_group, &drawer_top);
    t2 = high_resolution_clock::now();
    func_exec_time = (t2 - t1);
